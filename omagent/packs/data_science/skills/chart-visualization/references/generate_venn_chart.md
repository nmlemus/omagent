...
## Functional Overview
Displays logical relationships and overlaps between different sets.

## Input Fields
### Required
- `data`: array<object>, each record containing `value` (number) and `sets` (string[]), optional `label` (string).
