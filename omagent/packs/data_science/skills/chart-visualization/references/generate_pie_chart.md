...
## Functional Overview
Displays the composition of a whole. Can form a donut chart by setting innerRadius.

## Input Fields
### Required
- `data`: array<object>, each record containing `category` (string) and `value` (number).
