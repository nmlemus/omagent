...
## Functional Overview
Visualizes the progressive reduction of data as it passes through sequential stages.

## Input Fields
### Required
- `data`: array<object>, ordered by process flow, each containing `category` (string) and `value` (number).
