...
## Functional Overview
Displays the structure of an organization, showing hierarchical relationships.

## Input Fields
### Required
- `data`: object, required. Node contains `name` (string), optional `description`. Nested via `children` (array<object>).
