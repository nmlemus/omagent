...
class AgentPlan:
    ...
    def parse_from_text(cls, text: str) -> "AgentPlan | None":
        """Parse a plan from <plan> tags in LLM output.

        Pack-agnostic — works for any domain. The agent is instructed
        to wrap plans in <plan> tags via the system prompt.
        """
